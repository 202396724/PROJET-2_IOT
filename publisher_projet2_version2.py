...
# Command processing
commands = {
    "mode 1": "Mode normal activé",
    "mode 2": "Mode rouge activé (piéton)",
    "mode 3": "Mode 3 (feu 1 vert) activé",
    "mode 4": "Mode 4 (feu 2 vert) activé",
    "mode 5": "Mode 5 (clignotement) activé"
}
